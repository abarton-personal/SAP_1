...
HD_PWD='C:/Users/abarton/Documents/Vivado/SAP-1/SAP-1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sap_bus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sap_bus.tcl
