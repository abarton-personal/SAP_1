...
HD_PWD='C:/Users/abarton/Documents/Vivado/SAP-1/SAP-1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sap_bus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sap_bus.tcl -notrace
